...
//   const resolved = data.filter((element) => element.status == "Open");
    return (
       <div>
        <div className="container border-1 mx-auto flex justify-between mt-25" >
            <div className=" bg-gradient-to-r from-[#632EE3]  to-[#9F62F2] h-[300px] w-[750px] flex flex-col justify-center items-center rounded-2xl">
                <p className=" text-5xl font-bold text-white mb-3">In progress</p>
                <p className="text-8xl font-bold text-white">{inProgressCount}</p>
            </div>
            <div className="bg-gradient-to-r from-[#54CF68]  to-[#00827A] h-[300px] w-[750px] flex flex-col justify-center items-center rounded-2xl">
